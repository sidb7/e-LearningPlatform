...
const LandingPage = () => {
  ...
  const { shoppingCartData, setShoppingCartData } = useContext(ContextState);

  const addTocart = (ele) => {
    console.log(ele, "COURSE ADDED");
    cartItems.push(ele);
    setShoppingCartData(cartItems);
            ...
            <div class="grid xl:grid-cols-4  lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-2  gap-4 mb-4">
              ...
              {courseData.map((ele, index) => {
                return (
                  <div
                    key={index}
                    class=" flex items-center justify-center h-fit rounded bg-gray-50 dark:bg-gray-800"
                  >
                    <Popover
                    ...
                    >
                      ...
                      >
                        <div>
                          <div>
                            <h5 className="font-semibold leading-5 h-10 font-serif line-clamp-2  tracking-tight text-gray-900 dark:text-white">
                              {ele.name}
                            </h5>
                      ...
                      >
                        ...
                        <div className="mb-2 text-justify">
                          <div className="flex items-center gap-2">
                            ...
                            <p className="p-1">
                              {" "}
                              Apernatur magnam odio ipsa vitae quas, illo,
                              architecto aut,
                            </p>
                          </div>
                          <div className="flex items-center gap-2">
                        ...
                        <div className="flex w-full ">
                          {shoppingCartData.find(
                            ...
                            <Button
                              ...
                              className="bg-violet-500 w-full focus:border-none rounded-none border-0 p-2 font-bold text-white focus:border-0 hover:bg-violet-700  "
                            >
                              Go to cart
                            </Button>
                          ) : (
