            ...
            <div class="p-2 sm:ml-64 w-full  px-5">
                <div class="p-1 w-full mt-14">
                    ...
                    <div className="flex justify-center w-full ">
                        <div class="inline-flex whitespace-nowrap rounded-md shadow-sm my-6 gap-3 overflow-scroll no-scrollbar" role="group">
                    ...
                    <div class="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-2  gap-4 mb-4">
                        ...
                        {courseData.map((ele, index) => {
                            return (<div class=" flex items-center justify-center h-fit rounded bg-gray-50 dark:bg-gray-800">
                                <Popover open={openPopover == ele.name} handler={setOpenPopover} placement="right">
                                    <Card
                                        onMouseOver={() => { setOpenPopover(ele.name) }}
                                    ...
                                    >
                                        <div >
                                            <div>
                                                ...
                                                <p className="text-xs mt-2 text-gray-600 line-clamp-1">{ele.author}</p>
                                            </div>
                                            ...
                                            <div className="leading-10 mt-0">
                                                <div class="flex items-center  text-2xs leading-6">
                                                    ...
                                                    <p class=" font-bold text-gray-900 dark:text-white">4.95</p>
                                                    <span class="w-1 h-1 mx-1.5 bg-gray-500 rounded-full dark:bg-gray-400"></span>
                                                    <a href="#" class="font-medium text-gray-900 underline hover:no-underline dark:text-white">73 reviews</a>
                                                </div>
                                    ...
                                    <PopoverContent {...triggers} className="z-50 "  onMouseOver={() => { setOpenPopover(ele.name) }}
                                        onMouseOut={() => setOpenPopover(false)}>
